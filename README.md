 ...
 if FileSupport then
 if not isfolder('Flux-Admin') then
 makefolder('Flux-Admin')
 end
 
 if not isfolder('Flux-Admin/Plugins') then
	 makefolder('Flux-Admin/Plugins')
 end
 
 if not isfile("Flux-Admin/Prefix.txt") then
 writefile("Flux-Admin/Prefix.txt", ';')
 else
 end
 end
 ...
 local opt = {
	 prefix = readfile("Flux-Admin/Prefix.txt", ';'), -- If player's executor has the custom file function support it reads the prefix file to get prefix
...
--]]
 ...
 writefile("Flux-Admin\\Prefix.txt", PrefixChange)
 opt.prefix = PrefixChange
 Notify({
...
print(Time)
 ...
 Pingtext.BackgroundColor3 = Color3.fromRGB(250, 250, 250)
 ...
 Pingtext.Text = "FPS:"
 Pingtext.TextColor3 = Color3.fromRGB(0, 0, 0)
 ...
 Fpstext.Parent = Fps
 Fpstext.BackgroundColor3 = Color3.fromRGB(250, 250, 250)
 ...
 Notify({
	 Description = "Flux Admin currently has ".. commandcount .. " commands";
	 Title = "Flux Admin";
	 Duration = 5;
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/FD2Team/archive/main/Comet"))();
 ...
 On.Name = "On"
 On.Parent = GUI
 On.BackgroundColor3 = Color3.fromRGB(250, 250, 250)
...
if b:IsA("Folder") then
 ...
 cmd.add({"admin"}, {"admin", "whitelist someone to allow them to use commands"}, function(...)
	 ...
	 if Player ~= nil and not Admin[Player.UserId] then
		 ...
		 ChatMessage("/w "..Player.Name.." [Flux Admin] You've got admin. Prefix: ';'")
		 wait(0.2)
		 ChatMessage("/w "..Player.Name.." [Flux Admin Commands] glue, unglue, fling, fling2, spinfling, unspinfling, fcd, fti, fpp, fireremotes, holdhat")
...
-- [[ THANKS TO LIGHTING BOLT FOR THIS ]] --
 ...
 cmd.add({"functionspy"}, {"functionspy", "Check console"}, function()
	 ...
	 LeftPanel.BackgroundColor3 = Color3.fromRGB(235, 235, 235)
	 ...
	 example.BackgroundColor3 = Color3.fromRGB(230, 230, 230)
	 ...
	 FakeTitle.BackgroundColor3 = Color3.fromRGB(240, 240, 240)
	 ...
	 FakeTitle.TextColor3 = Color3.fromRGB(0, 0, 0)
	 ...
	 clear_2.TextColor3 = Color3.fromRGB(0, 0, 0)
 ...
 speed = (...)
	 ...
	 if table.find({Enum.Platform.IOS, Enum.Platform.Android}, game:GetService("UserInputService"):GetPlatform()) then 
		 ...
		 Notify({
		 Description = "Flux Admin has detected you using mobile you now have a mfly button click it to enable / disable mobile flying (For easier use)";
		 Title = "Flux Admin";
		 Duration = 5;
		 });
	 ...
	 TextButton.BackgroundColor3 = Color3.fromRGB(250, 250, 250)
...
game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(A_1,A_2)
 ...
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FD2Team/Flux-Admin-No-Byfron-Kick/main/AnimationSpoofer"))()
 end)
...
print(text)
 ...
 TextLabel_2.Text = "You are executing an anti-chat-log script meaning that Flux Admin wouldnt be able to detect when you have chatted meaning if you are on mobile and use the chat to execute commands it wont work. Are you sure you want to execute this?"
...
print(Time)
		 ...
		 local MakeGuiThread = coroutine.wrap(function()
			 ...
			 WarningLbl.TextColor3 = Color3.fromRGB(0, 0, 0)
			 ...
			 Despair.TextColor3 = Color3.fromRGB(0, 0, 0)
...
getChar().HumanoidRootPart.CFrame = target.Character.Humanoid.RootPart.CFrame
 ...
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FD2Team/Flux-Admin-No-Byfron-Kick/main/pp"))()
 end)
...
until glueloop == false
		 ...
		 v:Disconnect()
				 ...
				 cmd.add({"prompt", "purchaseprompts"}, {"prompt (purchaseprompts)", "allows the stupid purchase prompt"}, function()
					 ...
					 game.CoreGui.PurchasePrompt.Enabled = true
								 ...
								 cmd.add({"Flux"}, {"Flux", "Makes your hats visible but not your name or your body"}, function()
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FD2Team/archive/main/Flux"))()
 end)
 ...
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FD2Team/Flux-Admin-No-Byfron-Kick/main/Notepad"))()
 end)
...
-]]
 ...
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FD2Team/Flux-Admin-No-Byfron-Kick/main/GiveHat"))()
 end)
...
game.Players.LocalPlayer.CameraMode = "LockFirstPerson"
 ...
 if table.find({Enum.Platform.IOS, Enum.Platform.Android}, game:GetService("UserInputService"):GetPlatform()) then 
	 ...
	 Notify({
	 Description = "Flux Admin has detected you using mobile you now have a invisible button click it to enable / disable invisibility";
	 Title = "Flux Admin";
	 Duration = 7;
	 });
 ...
 cmd.add({"httpspy"}, {"httspy", "HTTP Spy"}, function()
	 loadstring(game:HttpGet('https://raw.githubusercontent.com/FD2Team/Flux-Admin-No-Byfron-Kick/main/HttpSpy'))()
 end)
 ...
 local success, result = pcall(function()
			 for i,v in pairs(listfiles("Flux-Admin/Plugins")) do
			 loadstring(readfile(listfiles("Flux-Admin/Plugins")[i]))();
...
-- table.find({Enum.Platform.IOS, Enum.Platform.Android}, game:GetService("UserInputService"):GetPlatform()) | searches if the player is on mobile.
 ...
 TextClickButton.BackgroundColor3 = Color3.fromRGB(250, 250, 250)
 ...
 TextClickButton.Text = "Flux Admin " .. currentversion .. ""
 TextClickButton.TextColor3 = Color3.fromRGB(0, 0, 0)
